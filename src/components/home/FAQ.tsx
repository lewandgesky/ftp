      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col md:flex-row gap-12 lg:gap-24">
          <div className="md:w-1/3">
            ...
            <div className="p-6 rounded-2xl glass border-[#2a2a3e] shadow-lg">
          ...
          <div className="md:w-2/3">
            <div className="space-y-4">
              {Array.isArray(faqs) && faqs.map((faq, index) => (
                <div 
                  key={index} 
                  className={`border border-[#2a2a3e] rounded-xl overflow-hidden transition-all duration-300 ${
                    openIndex === index ? "bg-[#1a1a2e] shadow-md border-[#3a3a52]" : "bg-[#0a0a0f] hover:border-[#3a3a52]"
                  }`}
                >
                  <button
                  ...
                  >
                    ...
                    <span className={`flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center transition-all duration-300 ${openIndex === index ? "bg-[#7c3aed]/20 text-[#7c3aed] rotate-180" : "bg-[#1a1a2e] text-[#8888a0]"}`}>
