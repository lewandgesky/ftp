  ...
  const services = [
    {
      ...
      key: "report",
      icon: (
        <div className="w-12 h-12 rounded-xl bg-[#12121a] border border-[#22223a] flex items-center justify-center text-[#06b6d4] mb-4">
    ...
    },
    {
      ...
      key: "powerpoint",
      icon: (
        <div className="w-12 h-12 rounded-xl bg-[#12121a] border border-[#22223a] flex items-center justify-center text-[#f59e0b] mb-4">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
