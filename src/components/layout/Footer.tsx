...
export function Footer() {
  ...
  return (
    <footer className="bg-[#0a0a0f] border-t border-[#2a2a3e] pt-16 pb-8 relative overflow-hidden">
      {/* Background glow */}
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/admin" className="text-sm text-[#8888a0] hover:text-[#7c3aed] transition-colors">
                  {t("nav.admin")}
                </Link>
              </li>
            </ul>
        ...
        <div className="pt-8 border-t border-[#2a2a3e] flex flex-col md:flex-row items-center justify-between gap-4">
