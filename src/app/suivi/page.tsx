  ...
  return (
    <div className="container mx-auto px-4 md:px-6 py-24 md:py-32">
      <div className="max-w-3xl mx-auto">
        ...
        {!order ? (
          <Card className="bg-[#0a0a0f] border-[#2a2a3e] max-w-md mx-auto">
          ...
          <div className="space-y-8 animate-fade-in-up">
            ...
            <Card className="bg-[#0a0a0f] border-[#2a2a3e] overflow-hidden">
              {/* Timeline Header */}
              <div className="bg-[#12121a] border-b border-[#2a2a3e] p-6 md:p-8">
                ...
                <div className="relative pt-8 pb-4">
                  <div className="absolute top-10 left-0 w-full h-[2px] bg-[#2a2a3e] z-0"></div>
                        ...
                        <div key={s} className="flex flex-col items-center group relative">
                          <div 
                            className={`w-5 h-5 rounded-full mb-3 flex items-center justify-center border-2 transition-colors duration-500 ${
                              ...
                              isActive ? "bg-[#06b6d4] border-[#06b6d4]" : "bg-[#0a0a0f] border-[#2a2a3e]"
                            }`}
                          >
                            {isActive && !isCurrent && (
