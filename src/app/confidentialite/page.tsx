    ...
    <main className="flex min-h-screen flex-col">
      ...
      <div className="flex-1 bg-[#0f172a] pt-24 pb-20">
        <div className="container mx-auto px-4 md:px-6 max-w-4xl">
          <h1 className="text-3xl md:text-5xl font-bold mb-8 text-[#f1f5f9]">Politique de Confidentialité</h1>
          
          <div className="bg-[#1e293b] border border-[#334155] rounded-xl p-6 md:p-10 space-y-6 text-[#94a3b8]">
            <section>
              <h2 className="text-xl font-semibold text-[#f1f5f9] mb-3">1. Collecte des données</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#f1f5f9] mb-3">2. Utilisation des données</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#f1f5f9] mb-3">3. Protection des données et confidentialité</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#f1f5f9] mb-3">4. Conservation des données</h2>
              <p>
