...
function OrderFormContent() {
  ...
  return (
    <div className="container mx-auto px-4 md:px-6 py-24 md:py-32 max-w-3xl">
      ...
      <Card className="bg-[#0a0a0f] border-[#22223a]">
        <CardContent className="p-6 md:p-8">
          
          {/* STEP 1: Personal Info */}
          {step === 1 && (
            <div className="space-y-6 animate-fade-in">
              <h2 className="text-xl font-semibold border-b border-[#22223a] pb-3 mb-6">{t("order.step1")}</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <select 
                    ...
                    className="flex h-10 w-full rounded-md border border-[#22223a] bg-[#0a0a0f] px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#7c3aed] text-[#f0f0f5]"
                  >
          ...
          {step === 4 && (
            <div className="space-y-6 animate-fade-in">
              <h2 className="text-xl font-semibold border-b border-[#22223a] pb-3 mb-6">{t("order.step4")}</h2>
              
              <div className="border-2 border-dashed border-[#22223a] rounded-xl p-8 text-center bg-[#12121a] hover:bg-[#12121a] transition-colors relative">
                <input 
                  type="file" 
                  multiple 
                ...
                />
                <div className="w-12 h-12 rounded-full bg-[#12121a] border border-[#3a3a52] flex items-center justify-center mx-auto mb-4 text-[#7c3aed]">
              ...
              {formData.files.length > 0 && (
                <div className="space-y-3 mt-6">
                  ...
                  {formData.files.map((file, index) => (
                    <div key={index} className="flex items-center justify-between p-3 rounded-lg bg-[#12121a] border border-[#22223a]">
          ...
          {step === 5 && (
            <div className="space-y-6 animate-fade-in">
              <h2 className="text-xl font-semibold border-b border-[#22223a] pb-3 mb-6">{t("order.step5")}</h2>
                    ...
                    <div 
                      ...
                      className={`cursor-pointer rounded-xl border p-4 transition-all ${
                        formData.serviceType === service.id 
                          ...
                          : "border-[#22223a] bg-[#12121a] hover:border-[#3a3a52]"
                      }`}
                    >
              ...
              {/* Summary */}
              <div className="mt-8 p-6 rounded-xl bg-[#12121a] border border-[#22223a]">
                <h3 className="font-semibold mb-4 border-b border-[#22223a] pb-2">{t("order.summary")}</h3>
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between pt-4 mt-4 border-t border-[#22223a]">
          ...
          {/* Navigation Buttons */}
          <div className="mt-10 flex justify-between pt-6 border-t border-[#22223a]">
            <Button 
              type="button" 
              variant="outline" 
              onClick={prevStep} 
