...
export default function AdminPage() {
  ...
  if (!isLoggedIn) {
    return (
      <main className="flex min-h-screen flex-col">
        <Navbar />
        <div className="flex-1 bg-[#050508] flex items-center justify-center py-20 px-4">
          <Card className="w-full max-w-md bg-[#0a0a0f] border-[#2a2a3e]">
  ...
  return (
    <main className="flex min-h-screen flex-col">
      <Navbar />
      <div className="flex-1 bg-[#050508] pt-24 pb-12">
        <div className="container mx-auto px-4 md:px-6">
          ...
          {activeTab === "orders" && (
            <div className="space-y-4">
              {orders.length === 0 ? (
                <Card className="bg-[#0a0a0f] border-[#2a2a3e] p-12 text-center text-[#8888a0]">
                  Aucune commande pour le moment.
                </Card>
              ) : (
                <div className="grid grid-cols-1 gap-4">
                  {orders.sort((a, b) => new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime()).map(order => (
                    <Card key={order.id} className="bg-[#12121a] border-[#2a2a3e] overflow-hidden">
                      <div className="p-4 md:p-6 flex flex-col md:flex-row justify-between gap-4">
                        <div className="flex-1">
                          <div className="flex items-center gap-3 mb-2">
                            ...
                            <span className="text-xs bg-[#2a2a3e] px-2 py-1 rounded text-[#d0d0d5]">
                        ...
                        <div className="md:w-64 border-t md:border-t-0 md:border-l border-[#2a2a3e] pt-4 md:pt-0 md:pl-6 flex flex-col justify-center">
                          <Label className="mb-2 block">Statut</Label>
                          <select 
                            value={order.status} 
                            onChange={(e) => handleStatusChange(order.id, e.target.value as OrderStatus)}
                            className="w-full bg-[#0a0a0f] border border-[#2a2a3e] rounded p-2 text-sm text-[#f0f0f5] focus:outline-none focus:ring-1 focus:ring-[#7c3aed]"
                          >
                          ...
                          <a 
                            ...
                            className="mt-4 w-full bg-[#25d366]/10 text-[#25d366] hover:bg-[#25d366]/20 py-2 rounded text-center text-sm font-medium transition-colors flex items-center justify-center gap-2"
                          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <Card className="bg-[#12121a] border-[#2a2a3e]">
                <CardContent className="p-6 md:p-8 space-y-6">
                  <h2 className="text-xl font-bold border-b border-[#2a2a3e] pb-4">Tarification (FCFA)</h2>
              ...
              <Card className="bg-[#12121a] border-[#2a2a3e]">
                <CardContent className="p-6 md:p-8 space-y-6">
                  <h2 className="text-xl font-bold border-b border-[#2a2a3e] pb-4">Sécurité</h2>
                  ...
                  <div className="pt-4 mt-6 border-t border-[#2a2a3e]">
